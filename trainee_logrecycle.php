	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			<ul class = "nav nav-pills">
				...
				<li class = ""><a href = "studentrecord_backup.php"><span class = "glyphicon glyphicon-edit"></span> trainee record from recycle Bin</a></li>
...
<?php include ('header.php');
	...
	?>
                    ...
                    <div class="x_title">
                       ...
                       <h3><i class="fa fa-users"></i> Trainee's Information</h3><button  data-toggle="modal" data-target="#admin_modal" type="submit" name="submit" class="btn btn-danger"><i class="fa fa-plus-delete"></i> Delete All OJT Logs from recycle Bin</button></center>
                    ...
                    <div class="x_content">
						...
						$admin = $conn->query("SELECT * FROM `backup_login_logs` order by `school_number` ASC") or die(mysqli_error());
...
<form action="deleteall_recyclelogs.php" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <center><h4><i class="fa fa-delete"></i>Delete all OJT Logs permanently from Recycle Bin</h4></center>
...
<br>							
              ...
              <center>
			   ...
			   <a href="trainee_logrecycle.php"><button type="button" class="btn btn-primary"><i class="fa fa-times-circle-o"></i> Cancel</button></a>
			  </center>
			  </form>
			   </form>
            </div>
