...
<?php
$user_query  = mysql_query("select * from admin where id = '$id_session'")or die(mysql_error());
...
?>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$result= mysql_query("select * from admin where id = '".$_SESSION['id']."' order by id DESC") or die (mysql_error());
